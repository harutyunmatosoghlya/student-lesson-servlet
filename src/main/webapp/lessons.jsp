...
<table>
    ...
    <tr>
        ...
        <td><%=DateUtil.fromDateToWebString(lesson.getDuration())%>
        </td>
        <td><%=lesson.getLecturerName()%>
        </td>
        <td><%=lesson.getPrice()%>
        </td>
        <td><a href="/deleteLesson?id=<%= lesson.getId() %>" class="delete-link">DELETE</a> | <a
                href="/editLesson?id=<%= lesson.getId() %>" class="edit-link">EDIT</a></td>
    </tr>
    <%}%>
</table>
</body>
